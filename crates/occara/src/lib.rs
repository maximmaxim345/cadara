...
// We can not implement Send on the underlying cxx managed raw pointer, therefore this
...
pub mod internal {
    ...
    pub fn make_bottle_cpp(width: f64, height: f64, thickness: f64) -> crate::shape::Shape {
        crate::shape::Shape(crate::ffi::MakeBottle_wrapper(width, height, thickness))
    }
