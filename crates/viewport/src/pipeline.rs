...
use computegraph::{ComputeGraph, DynamicNode, NodeFactory, NodeHandle, OutputPort};
...
pub struct SceneGraph {
    ...
    pub primitive: OutputPort<Box<dyn iced::widget::shader::Primitive>>,
}
